...
export default function LoginPage() {
  ...
  return (
    <div className={`w-full max-w-[440px] ${quicksand.className}`}>
      ...
      <div
        className="bg-white dark:bg-background border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden"
        style={{
      ...
      >
        <div className="p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center border gap-2 bg-white text-[#0F1115] font-semibold rounded-lg py-3 px-6"
          >
          ...
          {/* Sign up link */}
          <p className="text-center text-[12px] text-gray-500 mt-2 dark:text-gray-400">
      ...
      <p className="text-center text-[11px] text-gray-500 dark:text-gray-400 font-sans mt-6">
        ...
        <a
          href="/contact"
          className="underline hover:text-gray-700 dark:hover:text-white/40 transition-colors"
        >
          Contact support
        </a>
      </p>
